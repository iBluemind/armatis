...
# -*- coding: utf-8 -*-
#
# Armatis documentation build configuration file, created by
...
release = armatis_current_version
...
latex_documents = [
    (master_doc, 'armatis.tex', 'Armatis Documentation',
     'Han Manjong', 'manual'),
]
